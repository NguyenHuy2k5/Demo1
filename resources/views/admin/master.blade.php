    ...
    <div class="app-wrapper">
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Huy Store</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="modules/categories/list.html" class="nav-link">
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="http://haohan.lovestoblog.com/" class="text-decoration-none;">Huy Studio</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
